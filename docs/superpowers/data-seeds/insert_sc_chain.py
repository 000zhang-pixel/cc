...
scenes = [
    ...
    },
    {
        ...
        "场景名称": "腕部链条特写",
        "场景类型": "产品特写",
        "场景描述_中文": "手腕自然弯曲，手机链挂在手腕或手指上，链条垂坠形态优美，侧光营造金属光泽感",
        "场景基底_英文": "close-up of hand wrist with decorative phone chain, natural drape, soft side lighting, metallic gloss",
        "风格基调词": "精致细腻,金属光感,高质感",
        "排除描述": "不要过度PS，不要假手模型，不要黑暗背景",
        "适用品类": "手机链",
        "适用平台": "得物",
        "是否启用": True,
        "权重": 10,
    ...
    },
    {
        ...
        "场景名称": "链条光影桌面特写",
        "场景类型": "静物特写",
        "场景描述_中文": "手机链铺展在浅色桌面或大理石台面上，利用窗边自然光制造链条阴影与光斑，极简高级",
        "场景基底_英文": "phone chain arranged on marble or light wood surface, natural window light creating shadows and highlights, minimalist luxury",
        "风格基调词": "极简高级,光影美学,材质展示",
        "排除描述": "不要杂乱道具，不要人工打光过重，不要颜色过多",
        "适用品类": "手机链",
        "适用平台": "得物",
        "是否启用": True,
        "权重": 8,
    ...
    },
    {
        ...
        "场景名称": "链条材质微距特写",
        "场景类型": "产品特写",
        "场景描述_中文": "极近距离拍摄链条编织纹路、扣件细节、金属接缝，展现工艺精度，光线精准控制展示金属质感",
        "场景基底_英文": "macro close-up of chain weave texture, metal clasp detail, precise lighting to reveal craftsmanship",
        "风格基调词": "工艺感,材质细节,品质背书",
        "排除描述": "不要失焦，不要过曝，不要背景干扰",
        "适用品类": "手机链",
        "适用平台": "得物",
        "是否启用": True,
        "权重": 8,
