...
CASES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "command": [
            ...
            "--format", "interactive",
            "--detail-level", "short",
            "--data", "middleware/templates/feishu_interactive_render_example_accept_short.json",
            "--identity", "default_app",
            "--chat", "hermes_board",
            "--next-owner", "Hermes_CEO",
            "--strict-hints",
    ...
    },
    {
        ...
        "command": [
            ...
            "--format", "interactive",
            "--detail-level", "short",
            "--data", "middleware/templates/feishu_interactive_render_example_ack_short.json",
            "--identity", "default_app",
            "--chat", "hermes_board",
            "--strict-hints",
            "--dry-run",
    ...
    },
    {
        ...
        "command": [
            ...
            "--format", "interactive",
            "--detail-level", "short",
            "--data", "middleware/templates/feishu_interactive_render_example_risk_short.json",
            "--identity", "default_app",
            "--chat", "hermes_board",
            "--strict-hints",
            "--dry-run",
